...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div class="group bg-white rounded-[56px] border border-[#EFEFEF] shadow-sm hover:shadow-2xl hover:border-[#E85A4F] transition-all duration-500 overflow-hidden">
        <div class="p-10">
            ...
            <h3 class="text-xl font-black text-[#1E2432] leading-tight mb-1">{{ $employee->full_name }}</h3>
